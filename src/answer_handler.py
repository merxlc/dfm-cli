...
PROCESS_ANSWER_URL = 'https://www.drfrostmaths.com/process-answer-new.php'
PROCESS_SKIP_URL = 'https://www.drfrostmaths.com/process-skipquestion2.php'

class AnswerHandler:
    def __init__(self, session):
        self.sesh = session
        self.headers = {'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64; rv:92.0) Gecko/20100101 Firefox/92.0'}
    ...
    def find_answer(self, data: dict, type_: str):
        ...
        r = self.sesh.post(PROCESS_ANSWER_URL, data=data, headers=self.headers)  # submit incorrect answer
    ...
    def find_answer_qid(self, data: dict, type_: str):
        ...
        r = self.sesh.post(PROCESS_ANSWER_URL, headers=self.headers, data=data)
    ...
    def submit(self, data: dict):
        try:
            r = self.sesh.post(PROCESS_ANSWER_URL, headers=self.headers, data=data, timeout=3)
